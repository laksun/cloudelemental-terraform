...
variable "schedule_expression" {
  description = "Schedule for Inspector assessment run AWS Schedule Expression: https://docs.aws.amazon.com/AmazonCloudWatch/latest/events/ScheduledEvents.html "
  type        = string
  #default     = "cron(0 14 * * *)"
  default = "rate(7 days)"
